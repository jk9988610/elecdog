...
export function runCarryMiddlePass({
  ...
  world.envProfile = {
    ...
    semDomainTag: semEnabled === true ? (passSpec.semDomainTag ?? profile.semDomainTag === true) : false,
    semReproWindow: profile.semReproWindow ?? 24,
    semDomainWindow: profile.semDomainWindow ?? profile.semReproWindow ?? 24,
