...
/** 观察台 — 繁殖言语：定向实质性 TX + 胞内 INTRA-TX + pairMorph A/B */
const OBSERVER_PAIR_SPEECH_STACK = {
  fissionEnabled: false,
  ecoFissEnabled: false,
  meiEnabled: true,
  meiMinAge: 32,
...
ENV_PROFILES.observer_repro_speech = {
  id: 'observer_repro_speech',
  label: '观察台·繁殖言语栈',
  ...W5_WISDOM_FULL,
  organismMode: 'multicell',
  ...ECO_REPRO_BASE,
...
const MULTICELL_V2_STACK = {
  ...
  embryonicTicks: 0,
  juvenileTicks: 72,
  juvenileFissBoost: 0.18,
  cellCoupleMinAir: 0.08,
  cellCoupleMinTemp: 0.12,
  mitIntervalTicks: 4,
  adultMitBase: 0.045,
  adultMitIntervalTicks: 6,
  adultMitEnvCouple: true,
  stemFreezeAtAdult: true,
  diffIntervalTicks: 4,
  celLogInterval: 32,
  cellCoupleMinSubstrate: 0.12,
  cellCoupleMinVisual: 0.08,
  senLogInterval: 16,
  senMinLoad: 0.04,
  senAuditoryWindow: 6,
  senDiffWeight: 0.38,
  ...
  fissionMaxPop: 28,
  gestationTicks: 64,
  meiCrossoverEnabled: true,
  meiCrossoverRate: 0.32,
  courtshipGraceTicks: 96,
  partnerFusDelayTicks: 48,
  partnerFusJitterTicks: 72,
  fertilizationDelayTicks: 40,
  postpartumCooldownTicks: 96,
  dockBaseProb: 0.35,
  meiMinAge: 40,
  kinshipDnaBlockEnabled: true,
  kinshipDnaBlockSim: 0.68,
  /** Z 区段近亲阻断阈值 — 田野同胞样本校准（observer-kinship-sibling-field，cap 0.88） */
  kinshipZoneBlockSim: {
    Z1: 0.88,
    Z2: 0.88,
    Z3: 0.88,
