...
## 五、WL-R · 繁殖核心智慧语言（2026-07-30 收敛）

> 完整设计见 **[WL_REPRO_CENTER.md](WL_REPRO_CENTER.md)**

| 层 | 内容 | 状态 |
|----|------|------|
| **CORE-R** | 繁殖事件邻域的 SEM 共现（PAIR/MEI/PRQ/…） | 机制 ✅ 语义田野 ❌ |
| **YI 衣** | 边界·躯体·塑形（CEL/MBR/subCell/链） | 机制 ✅ |
| **SHI 食** | 场通量·DRW·r–e（繁殖门控养分） | 机制 ✅ |
| **ZHU 住** | 依附·NUR/EMB·留置 provenance | 机制 ✅ |
| **XING 行** | ACT/MIG/社会位·FLD 场交换 | 机制 ✅ |

**WL-R1（下一步）**：`[SEM]` 增加 `domain` 标记 + 繁殖邻域窗口田野 — 检验四域载荷是否服务 CORE-R。

---

*载荷共现是统计事实，不是词典条目。繁殖是智慧语言的核，衣食住行是四域交流。*
